...
/******/ 			var chunk = require("./" + ({"1":"components/options","2":"components/pulse","3":"pages/index"}[chunkId]||chunkId) + ".js");
...
module.exports = JSON.parse("{\"title\":\"bootleg breathing\",\"meta\":[{\"hid\":\"charset\",\"charset\":\"utf-8\"},{\"hid\":\"viewport\",\"name\":\"viewport\",\"content\":\"width=device-width, initial-scale=1\"},{\"hid\":\"mobile-web-app-capable\",\"name\":\"mobile-web-app-capable\",\"content\":\"yes\"},{\"hid\":\"apple-mobile-web-app-title\",\"name\":\"apple-mobile-web-app-title\",\"content\":\"bootleg breathing\"},{\"hid\":\"theme-color\",\"name\":\"theme-color\",\"content\":\"#FFAF00\"},{\"hid\":\"og:type\",\"name\":\"og:type\",\"property\":\"og:type\",\"content\":\"website\"},{\"hid\":\"og:title\",\"name\":\"og:title\",\"property\":\"og:title\",\"content\":\"bootleg breathing\"},{\"hid\":\"og:site_name\",\"name\":\"og:site_name\",\"property\":\"og:site_name\",\"content\":\"bootleg breathing\"}],\"link\":[{\"hid\":\"shortcut-icon\",\"rel\":\"shortcut icon\",\"href\":\"/_nuxt/icons/icon_64x64.808602.png\"},{\"hid\":\"apple-touch-icon\",\"rel\":\"apple-touch-icon\",\"href\":\"/_nuxt/icons/icon_512x512.808602.png\",\"sizes\":\"512x512\"},{\"rel\":\"manifest\",\"href\":\"/_nuxt/manifest.38811499.json\",\"hid\":\"manifest\"}],\"htmlAttrs\":{\"lang\":\"en\"}}");
...
var ___CSS_LOADER_API_IMPORT___ = __webpack_require__(3);
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
___CSS_LOADER_EXPORT___.push([module.i, "@import url(https://fonts.googleapis.com/css2?family=Gantari:wght@500&display=swap);"]);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "body,html{height:100%;-webkit-user-select:none;-moz-user-select:none;user-select:none;overflow-x:hidden;font-family:\"Gantari\",sans-serif}body{display:flex;align-items:center;justify-content:center;background:#2d2d2d;color:#fff;overflow:hidden}p{text-align:center;font-size:42px;margin-top:0}ul{list-style-type:none;padding:0}hr{border:none}.no-display{display:none}.no-animation{animation:none!important}.is-block{display:block!important}.container{padding:0;max-width:100%!important}.custom-range::-webkit-slider-thumb{background-color:#ffaf00;box-shadow:0 0 5px #fff}.custom-range::-moz-range-thumb{background-color:#ffaf00;box-shadow:0 0 5px #fff}.custom-range::-ms-thumb{background-color:#ffaf00;box-shadow:0 0 5px #fff}.explanation-alert{display:flex;position:absolute;max-width:420px;margin:-35px auto auto;left:20px;right:20px;height:320px;opacity:.95;padding:42px}.explanation-alert div{max-height:100%;height:100%;width:100%;overflow-y:scroll}.explanation-alert .github-link{text-decoration:none;color:#000}.bottom-buttons{position:absolute;width:calc(100% - 40px);max-width:320px;left:20px;right:20px;margin:auto;bottom:20px}.bottom-buttons .reset-button{float:right}.option-buttons .btn,.option-buttons .form-group{margin:24px auto;width:220px}.option-buttons .form-group .btn{margin:0}.option-buttons .number-input{display:block;width:100%;margin:auto;max-width:80px}.option-buttons .slider-input{display:block;max-width:70%;margin:auto}.option-buttons span{font-size:18px}.previous-round-time{position:absolute;top:12px;left:0;right:0}.previous-round-time p{font-size:24px;opacity:.75}.previous-round-time label{display:block;font-size:10px;margin-top:-6px}.round-counter{position:absolute;top:58px;left:0;right:0}.round-counter h1{padding:12px;font-weight:700}.round-counter #collapse-1{height:calc(100vh - 180px);position:absolute;width:80vw;width:inherit;left:0;right:0;margin:auto;background:#000;opacity:.9;z-index:2;padding:18px;top:42px;overflow:hidden;border-radius:15px}@media(min-width:500px){.round-counter #collapse-1{width:500px}}.round-counter #collapse-1 .times-list ul{display:block;height:calc(100vh - 280px);overflow-y:scroll}.round-counter #collapse-1 .times-list li{display:block}.main-button{border-radius:100%;height:250px;width:250px;background:radial-gradient(circle,hsla(0,0%,100%,0) 0,#fff 0,#ffaf00 76%);font-size:48px;color:#fff;text-shadow:0 0 10px #000}.main-button,.main-button h1{line-height:250px;margin:0 auto}.main-button h1{text-align:center}.main-button:focus{display:none}.main-button-secondary:active,.main-button-secondary:focus,.main-button-secondary:hover,.main-button-secondary:visited,.main-button:active,.main-button:focus,.main-button:hover{background:radial-gradient(circle,hsla(0,0%,100%,0) 0,#fff 0,#ffaf00 76%)!important}.pulse{animation-name:pulse;animation-duration:1.75s;animation-timing-function:ease-in-out;animation-direction:alternate;animation-iteration-count:infinite}.inhale{height:1000px;width:1000px;max-width:1000px;line-height:1000px;margin:0;animation-name:inhale;animation-duration:1.5s;animation-timing-function:ease-in;animation-direction:alternate;animation-iteration-count:1}.exhale,.inhale{border-radius:100%}.exhale{animation-name:exhale;animation-duration:1.5s;animation-timing-function:ease-in-out;animation-direction:alternate;animation-iteration-count:1;animation-play-state:running;animation-fill-mode:forwards}.instructions{position:absolute;display:block;margin:auto;width:320px;bottom:48px;left:0;right:0;padding:24px;text-align:center;text-shadow:0 0 10px #000}.close,.close:hover{color:#fff}.modal-footer,.modal-header{border:none}#modal-1{color:#fff;opacity:.9!important;width:100%;max-width:520px;padding-left:0!important}@media(min-width:420px){#modal-1{width:420px;display:block;margin:auto;left:0;right:0}}#modal-1 .modal-dialog{margin:0 auto}#modal-1 .modal-footer .btn-secondary{display:none}#modal-1 h4{color:#ffaf00;font-weight:700;text-shadow:0 0 42px #ffaf00;opacity:1}#modal-1 h4:active,#modal-1 h4:hover{color:#fff;text-shadow:0 0 42px #ffaf00}.bg-dark{background:#000!important}.btn-primary{background:#2d2d2d!important;border:1px solid #4e555b}.border-bottom{border-bottom:1px solid #fff}@keyframes pulse{0%{transform:scale(.1);border-radius:100%}to{transform:scale(1.5);border-radius:400%}}@keyframes inhale{0%{transform:scale(.1);border-radius:100%}to{transform:scale(1);border-radius:100%}}@keyframes exhale{0%{transform:scale(4)}to{transform:scale(.1)}}@media(prefers-color-scheme:dark){body{background:#2d2d2d;color:#fff}.main-button{box-shadow:0 0 100px #fff;border:2px solid #fff}}.dark-mode{background:#2d2d2d;color:#fff}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
__webpack_require__.d(components_namespaceObject, "Options", function() { return Options; });
__webpack_require__.d(components_namespaceObject, "Pulse", function() { return Pulse; });
...
const _21934948 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 3).then(__webpack_require__.bind(null, 40)));
...
const Options = () => __webpack_require__.e(/* import() | components/options */ 1).then(__webpack_require__.bind(null, 41)).then(c => wrapFunctional(c.default || c));
const Pulse = () => __webpack_require__.e(/* import() | components/pulse */ 2).then(__webpack_require__.bind(null, 39)).then(c => wrapFunctional(c.default || c)); // nuxt/nuxt.js#8607
...
/* harmony default export */ var icon_plugin = (async function (ctx, inject) {
  const icons = {
    "64x64": "/_nuxt/icons/icon_64x64.808602.png",
    "120x120": "/_nuxt/icons/icon_120x120.808602.png",
    "144x144": "/_nuxt/icons/icon_144x144.808602.png",
    "152x152": "/_nuxt/icons/icon_152x152.808602.png",
    "192x192": "/_nuxt/icons/icon_192x192.808602.png",
    "384x384": "/_nuxt/icons/icon_384x384.808602.png",
    "512x512": "/_nuxt/icons/icon_512x512.808602.png",
    "ipad_1536x2048": "/_nuxt/icons/splash_ipad_1536x2048.808602.png",
    "ipadpro9_1536x2048": "/_nuxt/icons/splash_ipadpro9_1536x2048.808602.png",
    "ipadpro10_1668x2224": "/_nuxt/icons/splash_ipadpro10_1668x2224.808602.png",
    "ipadpro12_2048x2732": "/_nuxt/icons/splash_ipadpro12_2048x2732.808602.png",
    "iphonese_640x1136": "/_nuxt/icons/splash_iphonese_640x1136.808602.png",
    "iphone6_50x1334": "/_nuxt/icons/splash_iphone6_50x1334.808602.png",
    "iphoneplus_1080x1920": "/_nuxt/icons/splash_iphoneplus_1080x1920.808602.png",
    "iphonex_1125x2436": "/_nuxt/icons/splash_iphonex_1125x2436.808602.png",
    "iphonexr_828x1792": "/_nuxt/icons/splash_iphonexr_828x1792.808602.png",
    "iphonexsmax_1242x2688": "/_nuxt/icons/splash_iphonexsmax_1242x2688.808602.png"
  };
  ...
  const app = {
    head: {
      ...
      "link": [{
        ...
        "rel": "stylesheet",
        "href": "https:\u002F\u002Ffonts.googleapis.com\u002Fcss2?family=Gantari:wght@500&display=swap"
      }],
      "style": [],
      "script": []
    },
